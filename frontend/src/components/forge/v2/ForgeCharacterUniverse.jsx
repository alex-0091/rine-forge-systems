...
export function BusinessOwnerAvatar({ size = 'md', className = '', mood = 'neutral' }) {
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${className}`}>
      <div className={`rounded-2xl bg-gradient-to-tr from-slate-800 via-slate-900 to-dark-950 border-2 border-slate-700 flex items-center justify-center shadow-lg ${sizeMap[size]}`}>
...
export function ReceptionistCharacter({ state = 'active', size = 'md', className = '' }) {
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${sizeMap[size]} ${className}`}>
      ...
      <div className="relative w-full h-full rounded-2xl bg-gradient-to-b from-[#081824] to-[#040d14] border-2 border-cyan-400 shadow-lg shadow-cyan-500/30 flex flex-col items-center justify-center p-2 overflow-hidden group">
        <div className="absolute -top-1 w-3/4 h-3.5 border-t-2 border-cyan-400 rounded-t-full" />
        <div className="absolute top-2 -left-1 w-2.5 h-4.5 rounded-l-md bg-cyan-400 shadow-sm" />
        <div className="absolute top-2 -right-1 w-2.5 h-4.5 rounded-r-md bg-cyan-400 shadow-sm" />

        <div className="w-4/5 h-2/5 rounded-lg bg-dark-950 border border-cyan-500/40 flex items-center justify-center gap-1.5 px-1.5 shadow-inner">
        ...
        <div className="absolute -bottom-1 right-1 px-1.5 py-0.2 bg-cyan-400 text-dark-950 font-mono text-[8px] font-black rounded-md shadow">
          CALL
        </div>
      </div>
    </div>
...
export function LeadEngineCharacter({ state = 'active', size = 'md', className = '' }) {
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${sizeMap[size]} ${className}`}>
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-violet-500/20 via-purple-500/30 to-indigo-600/20 blur-xl animate-pulse pointer-events-none" />

      <div className="relative w-full h-full rounded-2xl bg-gradient-to-b from-[#180d28] to-[#0c0616] border-2 border-violet-400 shadow-lg shadow-violet-500/30 flex flex-col items-center justify-center p-2 overflow-hidden">
        <div className="absolute inset-1 rounded-xl border border-dashed border-violet-500/40 animate-spin" style={{ animationDuration: '7s' }} />

        <div className="w-4/5 h-2/5 rounded-lg bg-dark-950 border border-violet-500/50 flex items-center justify-center gap-1 shadow-inner relative">
          <Search className="w-3.5 h-3.5 text-violet-400 animate-pulse" />
          <span className="text-[10px] font-mono font-black text-violet-300">96</span>
        </div>
        ...
        <div className="w-4/5 mt-1.5 space-y-0.5">
          <div className="w-full h-1.5 bg-dark-950 rounded-full overflow-hidden border border-violet-500/30">
            <div className="h-full bg-gradient-to-r from-violet-400 to-cyan-400 rounded-full w-[96%]" />
          </div>
        ...
        <div className="absolute -bottom-1 right-1 px-1.5 py-0.2 bg-violet-400 text-dark-950 font-mono text-[8px] font-black rounded-md shadow">
          LEAD
        </div>
      </div>
    </div>
...
export function SupportCharacter({ state = 'active', size = 'md', className = '' }) {
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${sizeMap[size]} ${className}`}>
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-blue-500/20 via-sky-500/30 to-indigo-600/20 blur-xl animate-pulse pointer-events-none" />

      <div className="relative w-full h-full rounded-2xl bg-gradient-to-b from-[#0c1628] to-[#060a14] border-2 border-blue-400 shadow-lg shadow-blue-500/30 flex flex-col items-center justify-center p-2 overflow-hidden">
        ...
        <div className="w-4/5 h-2/5 mt-2 rounded-lg bg-dark-950 border border-blue-500/40 flex items-center justify-center gap-1 shadow-inner">
          ...
          <div className="w-2 h-2 rounded-full bg-sky-400 shadow-sm shadow-sky-300" />
        </div>
...
export function DocumentCharacter({ state = 'active', size = 'md', className = '' }) {
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${sizeMap[size]} ${className}`}>
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-orange-500/20 via-amber-500/30 to-red-600/20 blur-xl animate-pulse pointer-events-none" />

      <div className="relative w-full h-full rounded-2xl bg-gradient-to-b from-[#241208] to-[#120804] border-2 border-orange-400 shadow-lg shadow-orange-500/30 flex flex-col items-center justify-center p-2 overflow-hidden">
        <div className="absolute inset-x-0 h-0.5 bg-gradient-to-r from-transparent via-orange-400 to-transparent animate-pulse" style={{ top: '45%' }} />

        <div className="w-4/5 h-3/5 rounded-lg bg-dark-950 border border-orange-500/40 flex flex-col justify-between p-1.5 shadow-inner">
          <div className="flex items-center justify-between">
            <FileText className="w-3.5 h-3.5 text-orange-400" />
            <span className="text-[7px] font-mono text-orange-300 font-bold">OCR</span>
          </div>
          <div className="space-y-0.5">
            <div className="w-full h-1 bg-orange-500/30 rounded" />
        ...
        <div className="absolute -bottom-1 right-1 px-1.5 py-0.2 bg-orange-400 text-dark-950 font-mono text-[8px] font-black rounded-md shadow">
          DOC
        </div>
      </div>
    </div>
...
export function EmailCharacter({ state = 'active', size = 'md', className = '' }) {
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${sizeMap[size]} ${className}`}>
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-pink-500/20 via-fuchsia-500/30 to-rose-600/20 blur-xl animate-pulse pointer-events-none" />

      <div className="relative w-full h-full rounded-2xl bg-gradient-to-b from-[#240818] to-[#12040d] border-2 border-pink-400 shadow-lg shadow-pink-500/30 flex flex-col items-center justify-center p-2 overflow-hidden">
        <div className="w-4/5 h-3/5 rounded-lg bg-dark-950 border border-pink-500/40 flex flex-col justify-between p-1.5 shadow-inner">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[7px] font-mono px-1 py-0.2 rounded bg-pink-500/20 text-pink-300 border border-pink-500/30 font-bold">HOT</span>
          </div>
        ...
        <div className="absolute -bottom-1 right-1 px-1.5 py-0.2 bg-pink-400 text-dark-950 font-mono text-[8px] font-black rounded-md shadow">
          EMAIL
        </div>
      </div>
    </div>
...
export function AppointmentCharacter({ state = 'active', size = 'md', className = '' }) {
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${sizeMap[size]} ${className}`}>
      ...
      <div className="relative w-full h-full rounded-2xl bg-gradient-to-b from-[#082414] to-[#04120a] border-2 border-emerald-400 shadow-lg shadow-emerald-500/30 flex flex-col items-center justify-center p-2 overflow-hidden">
        <div className="w-4/5 h-3/5 rounded-lg bg-dark-950 border border-emerald-500/40 flex flex-col justify-between p-1.5 shadow-inner">
          ...
          <div className="grid grid-cols-4 gap-0.5 my-0.5">
            {[1,2,3,4].map(i => (
              <div key={i} className={`h-1.5 rounded-sm ${i === 3 ? 'bg-emerald-400' : 'bg-slate-800'}`} />
            ))}
          </div>
        ...
        <div className="absolute -bottom-1 right-1 px-1.5 py-0.2 bg-emerald-400 text-dark-950 font-mono text-[8px] font-black rounded-md shadow">
          BOOK
        </div>
      </div>
    </div>
