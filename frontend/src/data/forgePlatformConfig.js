...
export const SYSTEMS_CATALOG = [
  {
    ...
    headline: 'Automatically capture, qualify, score, and route inbound leads in under 60 seconds.',
    description: 'Engages inbound website visitors, portal leads, and webhooks in real time. Evaluates budget, urgency, and purchase criteria before locking calendar appointments for your top reps.',
    iconName: 'Zap',
    version: 'v3.4.2',
    status: 'ACTIVE',
    rating: 4.9,
    executionsTotal: 14280,
    successRate: '99.4%',
    avgLatency: '42ms',
    workflowSteps: [
      { step: '01', title: 'Webhook Ingestion', desc: 'Captures inquiry from website form, Zillow, or ad landing page.' },
      { step: '02', title: 'Intent & Budget Extraction', desc: 'Parses buyer purchasing capacity, timeline, and exact service need.' },
      { step: '03', title: 'Scoring & Qualification', desc: 'Assigns 0-100 ICP score based on your qualification criteria.' },
      { step: '04', title: 'CRM Commit & Routing', desc: 'Creates contact in HubSpot/Salesforce, assigns rep, and sends calendar booking link.' }
    ],
    demoConfig: {
  ...
  },
  {
    ...
    badge: 'VOICE & APPOINTMENTS',
    category: 'Operations & Triage',
    headline: 'Your 24/7 front-desk concierge for patient triage and instant bookings.',
  ...
  },
  {
    ...
    badge: 'OCR & DATA STRUCTURING',
    category: 'Operations & Triage',
    headline: 'Extract line items, validate totals, and commit invoice/contract data automatically.',
  ...
  },
  {
    ...
    badge: 'KNOWLEDGE BASE RAG',
    category: 'Customer Support',
    headline: 'Instant, accurate 24/7 customer support strictly grounded in your approved documentation.',
  ...
  },
  {
    ...
    badge: 'DEEP DATA SYNTHESIS',
    category: 'Research & Intelligence',
    headline: 'Synthesize complex market data, competitor intelligence, and legal filings into executive briefs.',
    ...
    demoConfig: {
      ...
      sampleOutput: {
        ...
        sourcesAnalyzed: 14,
        credibilityRating: 'VERIFIED_MULTI_SOURCE (98%)',
  ...
  },
  {
    id: 'oracle-ai',
    slug: 'oracle-ai',
    name: 'FORGE Oracle AI Engine',
    badge: 'QUANT MICROSTRUCTURE',
    category: 'FinTech & Intelligence',
    headline: 'Real-time 5m candle structure, orderbook depth imbalance, and directional vector intelligence.',
    description: 'High-throughput quantitative timeseries engine streaming live microstructure signals, liquidity density mapping, and probabilistic directional vectors at sub-14ms stream latency.',
    iconName: 'Activity',
    version: 'v5.0.1',
    status: 'ACTIVE',
    rating: 4.98,
    executionsTotal: 1240000,
    successRate: '99.9%',
    avgLatency: '11ms',
    workflowSteps: [
      { step: '01', title: 'WebSocket Ingest', desc: 'Non-blocking async ring buffers streaming live L2 orderbook feeds.' },
      { step: '02', title: 'Microstructure Analytics', desc: 'NumPy/Pandas timeseries calculating RSI, MACD, and order imbalance.' },
      { step: '03', title: 'Vector Confidence Score', desc: 'Evaluates liquidity depth skew to output directional probability.' },
      { step: '04', title: 'Risk Protocol Gating', desc: 'Bounds automated take-profit and stop-loss parameters.' }
    ],
    demoConfig: {
